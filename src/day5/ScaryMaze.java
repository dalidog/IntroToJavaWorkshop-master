...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("daliascarymaze.jpg"));
		//2. set the mouse pointer to the start of your maze using:
		new Robot().mouseMove(100,120 );
	...
	public void mouseMoved(MouseEvent e) {
		...
		int endcolor=maze.getRGB(100, 500);
...
int backgroundcolor = maze.getRGB(1,1);
	...
	@Override
	public void run() {
		JFrame frame = new JFrame("Dalia'a Scary Maze");
		frame.add(this);
