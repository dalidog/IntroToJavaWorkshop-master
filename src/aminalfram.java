...
public class aminalfram {
	...
	aminalfram() {
		...
		String answer = JOptionPane.showInputDialog("What person do you want because people are like aminals? You can choose Stalin, Gorbochev, or  Trump.");
		if (answer.equals("Stalin")) {
			playMoo();
		}
	
	else if(answer.equals("Gorbochev"))

	{
		playQuack();
	} else if(answer.equals("Trump"))
